...
BUILDDIR=$(realpath ..)
MACHINE=lea-trevally
TAR_XZ_LINK=${BUILDDIR}/deploy-ti/images/${MACHINE}/core-image-minimal-${MACHINE}.rootfs.tar.xz
...
cp ${BUILDDIR}/../../u-boot/lea_trevally/{tiboot3.bin,tispl.bin,u-boot.img} ${MOUNT_DIR}/boot/
