ROOTFS_POSTPROCESS_COMMAND:append:lea-remy = " remove_bone_i2c_overlays; "
...
ROOTFS_POSTPROCESS_COMMAND:append:lea-remy = " remove_fitimage_and_efi; "
...
ROOTFS_POSTPROCESS_COMMAND:append:lea-remy = " move_dtb_to_boot; "

move_dtb_to_boot() {
    if [ -f ${IMAGE_ROOTFS}/boot/dtb/ti/am62x-lea-remy.dtb ]; then
        mv -f ${IMAGE_ROOTFS}/boot/dtb/ti/am62x-lea-remy.dtb ${IMAGE_ROOTFS}/boot/am62x-lea-remy.dtb
    fi
