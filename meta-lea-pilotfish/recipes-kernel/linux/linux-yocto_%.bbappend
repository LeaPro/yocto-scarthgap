...
KBRANCH:lea-pilotfish = "v5.10/standard/beaglebone"

KMACHINE:lea-pilotfish ?= "beaglebone"

SRCREV_machine:lea-pilotfish ?= "3c44f12b9de336579d00ac0105852f4cbf7e8b7d"

COMPATIBLE_MACHINE:lea-pilotfish = "lea-pilotfish"

LINUX_VERSION:lea-pilotfish = "5.10.130"
...
SRC_URI += "file://devtool-fragment.cfg \
            ...
            file://am3352-lea-pilotfish-btprog.dts;subdir=git/arch/arm/boot/dts \
            "
do_install:append() {
    # create a symlink in /boot named am335x-boneblack.dtb for compatibility with legacy u-boot environment
    ln -sf am3352-lea-pilotfish.dtb ${D}/boot/am335x-boneblack.dtb
}