...
INFILE=./tmp/deploy/images/lea-dls/core-image-minimal-lea-dls.rootfs.tar.xz
OUTFILE=postBuild/images/DLS-${VERSION}-LEA-mARC-${DATE}.tar.xz.enc
mkdir -p postBuild/images
rm -rf $OUTFILE
openssl enc -aes-256-cbc -salt -in $INFILE -out $OUTFILE -k DLS!
